      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-16 items-center gap-2 px-6 border-b">
            ...
            <span className="text-xs bg-primary/10 text-primary px-2 py-1 rounded font-serif">Admin</span>
          </div>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="w-full justify-start gap-3 h-auto p-3">
                  <Avatar className="h-8 w-8">
                    ...
                    <AvatarFallback className="font-sans">AD</AvatarFallback>
                  </Avatar>
                  <div className="text-left">
                    <div className="text-sm font-medium font-sans">Admin User</div>
                    <div className="text-xs text-muted-foreground font-serif">admin@eclettico.com</div>
                  </div>
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem>
                  ...
                  <span className="font-serif">View Store</span>
                </DropdownMenuItem>
                <DropdownMenuItem>
